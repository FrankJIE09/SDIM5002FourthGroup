...
class Calibration2D(object):
    def __init__(self, cfg_path):
        ...
        # conveyor belt
        vector_1 = __cfg['vector_start']
        vector_2 = __cfg['vector_end']
        belt_direct = np.array(vector_2) - np.array(vector_1)
        self.belt_direct = belt_direct/np.linalg.norm(belt_direct)

        self.distance = __cfg['distance_camera_robot']
    ...
    def cvt(self, u, v):
        ...
        # x = gp_base[0][0][0] - (self.distance*self.belt_direct)[0]
        # y = gp_base[0][0][1] - (self.distance*self.belt_direct)[1]
        x = gp_base[0][0][0]
        y = gp_base[0][0][1]
        return x, y
